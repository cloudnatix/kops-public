...
func ListResources(cloud fi.Cloud, cluster *kopsapi.Cluster, region string) (map[string]*resources.Resource, error) {
	...
	case kops.CloudProviderAzure:
		return azure.ListResourcesAzure(cloud.(cloudazure.AzureCloud), clusterName, cluster.Spec.Azure.ResourceGroupName)
	default:
