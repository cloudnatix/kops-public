...
func (*ResourceGroup) RenderAzure(t *azure.AzureAPITarget, a, e, changes *ResourceGroup) error {
	if a == nil {
		return createResourceGroup(t, e)
	}
	return updateResourceGroup(t, e, changes)
}

func createResourceGroup(t *azure.AzureAPITarget, e *ResourceGroup) error {
...
func updateResourceGroup(t *azure.AzureAPITarget, e, changes *ResourceGroup) error {
