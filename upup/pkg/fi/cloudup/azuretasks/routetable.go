...
func (*RouteTable) RenderAzure(t *azure.AzureAPITarget, a, e, changes *RouteTable) error {
	if a == nil {
		return createRouteTable(t, e)
	}
	// TODO(kenji): Compare a(ctual) and e(xpected) state and update the virtual network.
	return errors.New("updating Route Table is not implemented yet")
}

func createRouteTable(t *azure.AzureAPITarget, e *RouteTable) error {
