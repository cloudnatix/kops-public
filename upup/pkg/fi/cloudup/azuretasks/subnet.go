...
func (*Subnet) RenderAzure(t *azure.AzureAPITarget, a, e, changes *Subnet) error {
	if a == nil {
		return createSubnet(t, e)
	}
	// TODO(kenji): Compare a(ctual) and e(xpected) state and update the subnet.
	return errors.New("updating Subnet is not implemented yet")
}

func createSubnet(t *azure.AzureAPITarget, e *Subnet) error {
