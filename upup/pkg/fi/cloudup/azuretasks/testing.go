...
func (c *MockAzureCloud) DeleteInstance(i *cloudinstances.CloudInstanceGroupMember) error {
...
func (c *MockAzureCloud) DetachInstance(i *cloudinstances.CloudInstanceGroupMember) error {
